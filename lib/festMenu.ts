  ...
  categories: [
    {
      ...
      items: [
        ...
        { id: "dv_b_dunk",      n: "Cheese Dunk Burger (Veg)",      p: 270, veg: 1,
          d: "Loaded with cheese, built to dunk - pure cheesy indulgence", tag: "MUST TRY"},
        { id: "dv_b_sig",       n: "Signature Burger (Veg)",        p: 270, veg: 1,
          d: "Chef's special patty, secret sauce, fresh layers - your perfect bite" },
        { id: "dv_b_double",    n: "Double Decker Burger (Veg)",    p: 350, veg: 1,
