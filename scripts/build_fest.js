...
'    if(onDone)onDone();\n' +
  ...
  extra.push(
    ...
    ".sheet{background:rgba(18,18,20,.82);background-image:none;" +
      ...
      "border:1px solid rgba(255,255,255,.08);border-bottom:0;color:var(--ink);padding:22px 18px 26px}",
    "#modal{background:rgba(0,0,0,.55)}",
    ".sheet h2{color:var(--ink)}",
    ".fbh{font-size:21px;font-weight:800;color:var(--ink);margin:4px 0 20px}",
    ".fbrow{display:flex;align-items:center;justify-content:space-between;gap:10px;margin:0 0 18px;" +
      "font-size:17px;font-weight:600;color:var(--ink)}",
    ".odystars{display:flex;gap:2px}",
    // grey until chosen, brand colour once lit — the tap target stays 34px either way
    ".fbst{width:44px;height:44px;border:0;background:none;font-size:32px;line-height:1;padding:0;" +
    ...
    ".fbtxt{width:100%;box-sizing:border-box;background:rgba(0,0,0,.42);border:1px solid rgba(255,255,255,.14);border-radius:12px;" +
      "color:var(--ink);font:inherit;font-size:16px;padding:13px 14px;resize:none;margin:4px 0 10px}",
    `.fbtxt:focus{outline:none;border-color:${ACC}}`,
    ".fbtxt::placeholder{color:#6c6c6c}",
    ".fbmsg{min-height:18px;font-size:14px;color:#c98a8a;margin:0 0 10px}",
    ".fbbtn{width:100%;justify-content:center;margin:0 0 10px;font-size:16px;padding:14px 18px}",
    ".sheet .chip.alt{background:rgba(255,255,255,.07);border-color:rgba(255,255,255,.14)}",
    ".fbbtn:disabled{opacity:.4;cursor:default}",
    ".fbthx{font-size:16px;color:var(--mut);margin:0 0 20px}",
